...
dotenv.config();
var DB = dbConfig.DB, ROLES = dbConfig.ROLES;
var connect = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                console.log("Succesfully connected to the database ".concat(DB));
                initDB();
                return [2 /*return*/];
        }
    });
...
var initDB = function () { return __awaiter(void 0, void 0, void 0, function () {
    var count, roles, _i, roles_1, role, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 6, , 7]);
                return [4 /*yield*/, Role.estimatedDocumentCount()];
            case 1:
                count = _a.sent();
                if (!(count === 0)) return [3 /*break*/, 5];
                roles = ROLES.map(function (r) { return new Role({ name: r }); });
                _i = 0, roles_1 = roles;
                _a.label = 2;
            case 2:
            ...
            case 6:
                e_1 = _a.sent();
                console.log("Failed with error: ", e_1);
                return [3 /*break*/, 7];
